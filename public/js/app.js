...
var app = new vue__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get('api/resturant').then(function (response) {
      _this.resturants = response.data;
  ...
  methods: {
    ...
    handleCreateNewResturant: function handleCreateNewResturant(e) {
